...
class Client
{
    ...
    public function getThumbnailBatch(array $entries = []): array
    {
        ...
        return $this->contentBatchEndpointRequest('files/get_thumbnail_batch', $arguments);
    }
    ...
    public function contentBatchEndpointRequest(string $endpoint, array $parameters = null): array
    {
      try {
          ...
          $response = $this->client->post($this->getEndpointUrl('content', $endpoint), $options);
      } catch (ClientException $exception) {
          throw $this->determineException($exception);
      }
